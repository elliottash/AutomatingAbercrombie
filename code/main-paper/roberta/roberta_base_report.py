'''
Code for measurement analysis of Roberta-base model
Measurements - 
...
# model for predicting acq_in without translation 
roberta_base_model = '../models/roberta_v1_unprocessed.pth' 
...
# Function to get threshold for acq indicator - max difference b/w tpr and fpr 
...
# Function to get calibration plots 
def get_calibration_curve(target, pred_prob, save_loc, nbins=10):
    ...
    ax.add_line(line)
    fig.suptitle('Calibration plot for Roberta')
...
def report_metrics(op_path, temperature=None):
    ...
    if temperature is None:
        labels, pred_prob, predictions = bert_pred(roberta_base_model, X_test, y_test)
    else:
        labels, pred_prob, predictions = bert_pred(roberta_base_model, X_test, y_test, temp=temperature)

    # Classification Metrics 
    acc_model, classification_report_model = classification_metrics(labels, predictions)
    ...
    # Calibration Plot 
    get_calibration_curve(labels, pred_prob, op_path['calib_plot_path'])
...
op_no_temp = {'roc_auc_path':'../plots/roberta-base-unprocessed/auc_bert.png', 
              'calib_plot_path':'../plots/roberta-base-unprocessed/calib_plot_roberta.png',
              'prec_at_th_path':'../plots/roberta-base-unprocessed/threshold_precisions.csv',
              'decile_path':'../plots/roberta-base-unprocessed/decile_bert.csv'}
...
op_temp = {'roc_auc_path':'../plots/roberta-base-unprocessed/auc_bert_tscaled.png', 
              'calib_plot_path':'../plots/roberta-base-unprocessed/calib_plot_roberta_tscaled.png',
              'prec_at_th_path':'../plots/roberta-base-unprocessed/threshold_precisions_tscaled.csv',
              'decile_path':'../plots/roberta-base-unprocessed/decile_bert_tscaled.csv'}
