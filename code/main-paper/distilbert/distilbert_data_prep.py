...
# Output 
df_bert_input = '../../data/distilbert/df_bert_input.pkl'
...
class PrepareBERTData():
    ...
    def add_bert_input_text(self, df, preprocessed=True):
        if preprocessed:
            df['bert_input_processed'] = '[CLS] ' + df['mark_processed'] + ' [SEP] ' + df['statement_processed'] + ' [SEP] ' + df['mark_translated'] + ' [SEP] ' + df['wordnet_text'] + ' [SEP] ' + df['mark_length_text'] + ' [SEP] ' + df['nice_cat_text'] + ' [SEP] ' + df['nice_description_preprocessed'] + ' [SEP] ' + df['pseudo_mark_processed'] 
            print(df['bert_input_processed'][10])
        else:
            df['bert_input_unprocessed'] = '[CLS] ' + df['mark_unprocessed'] + ' [SEP] ' + df['statement_unprocessed'] + ' [SEP] ' + df['mark_translated'] + ' [SEP] ' + df['wordnet_text'] + ' [SEP] ' + df['mark_length_text'] + ' [SEP] ' + df['nice_cat_text'] + ' [SEP] ' + df['nice_description_unpreprocessed'] + ' [SEP] ' + df['pseudo_mark_unprocessed'] 
